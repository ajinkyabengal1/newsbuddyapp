...
const App = ()=> {
 ...
 const [progress, setProgress] = useState(0);
    ...
    return (
      ...
      />
      {/* <News setProgress={setProgress}  tpageSize={pageSize} country="in" category="sports" /> */}
      <Routes>
          <Route exact path="/" element = {<News setProgress={setProgress}   key="genral" pageSize ={pageSize} country = "in" category = "general"/>}/>
